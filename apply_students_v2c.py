  ...
  <style>
    ...
    *, *::before, *::after { margin:0; padding:0; box-sizing:border-box; }
    body { font-family:'Noto Serif JP',serif; background:var(--bg); color:var(--text);
      min-height:100vh; padding:56px 32px 80px; -webkit-font-smoothing:antialiased; }
    ...
    .header { margin-bottom:64px; padding-bottom:32px; border-bottom:1px solid var(--border-light);
    ...
    .logo-abbr { font-family:'DM Mono',monospace; font-weight:500; font-size:52px;
      letter-spacing:-4px; color:var(--text); line-height:1; }
    .logo-bracket { font-family:'DM Mono',monospace; font-size:38px; font-weight:300;
      color:var(--border-light); line-height:1; margin:0 4px; align-self:center; }
    .logo-fullname { font-family:'DM Mono',monospace; font-weight:400; font-size:13px;
      letter-spacing:6px; text-transform:uppercase; color:var(--text);
      margin-top:6px; display:flex; align-items:center; gap:12px; }
    .logo-fullname .dot { width:4px; height:4px; background:var(--blue);
      display:inline-block; box-shadow:0 0 6px var(--blue); }
    .logo-sub { font-family:'DM Mono',monospace; font-weight:300; font-size:9px;
    ...
    .header-meta .date { font-family:'DM Mono',monospace; font-size:10px;
    ...
    .cat-num { font-family:'DM Mono',monospace; font-size:10px; color:var(--text-dim);
      flex-shrink:0; letter-spacing:1px; }
    .cat-en { font-family:'DM Mono',monospace; font-weight:500; font-size:13px;
      letter-spacing:3px; text-transform:uppercase; }
    .cat-ja { font-family:'Noto Serif JP',serif; font-size:11px; font-weight:300;
    ...
    .menu-item { display:flex; align-items:center; gap:14px; padding:14px 16px;
      background:var(--surface); border:1px solid var(--border); border-left-width:2px;
      text-decoration:none; color:var(--text); transition:all 0.16s ease; cursor:pointer; }
    .menu-item:hover { background:var(--surface2); transform:translateX(3px); }
    .menu-icon { width:32px; height:32px; display:flex; align-items:center;
      justify-content:center; flex-shrink:0; position:relative; }
    .menu-icon::before { content:''; position:absolute; inset:0;
      border-top:1px solid currentColor; border-left:1px solid currentColor; opacity:0.25; }
    .menu-icon::after  { content:''; position:absolute; inset:0;
      border-bottom:1px solid currentColor; border-right:1px solid currentColor; opacity:0.25; }
    .menu-icon svg { width:16px; height:16px; stroke-width:1.5; }
    .menu-text { flex:1; min-width:0; }
    .menu-en { font-family:'DM Mono',monospace; font-weight:500; font-size:12px;
      letter-spacing:1.5px; text-transform:uppercase; white-space:nowrap;
      overflow:hidden; text-overflow:ellipsis; }
    .menu-ja { font-family:'Noto Serif JP',serif; font-size:10.5px; font-weight:300;
    ...
    .footer .ver { font-family:'DM Mono',monospace; font-size:10px;
...
<div class="container">
  ...
  <header class="header">
    <div class="logo-block">
      ...
      <div class="logo-fullname">
        <span>STUDY</span><span class="dot"></span><span>PLANNER</span>
      </div>
  ...
  <!-- 02 Students -->
  <section class="category students">
    <div class="cat-header">
      <span class="cat-num">02</span>
      <span class="cat-en">Students</span>
      <span class="cat-ja">生徒管理・スケジュール設定</span>
      <div class="cat-rule"></div>
    </div>
    <div class="menu-grid">
      <a class="menu-item" href="/students">
        ...
        <div class="menu-text">
          ...
          <div class="menu-ja">生徒情報・スケジュール・授業曜日</div>
        </div>
        <span class="menu-arrow">&#x2192;</span>
      </a>
    </div>
    ...
    <div class="menu-grid">
      ...
      <a class="menu-item" href="/record/list">
        <div class="menu-icon">
          <svg fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round"
              d="M11.42 15.17L17.25 21A2.652 2.652 0 0021 17.25l-5.877-5.877M11.42 15.17l2.496-3.03c.317-.384.74-.626 1.208-.766M11.42 15.17l-4.655 5.653a2.548 2.548 0 11-3.586-3.586l5.653-4.655m5.585-.367l-3.027 2.496"/>
          </svg>
        </div>
        <div class="menu-text">
