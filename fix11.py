...
<head>
  ...
  <title>生徒管理</title>
  <style>
    body { font-family: sans-serif; max-width: 800px; margin: 40px auto; background: #f5f7fa; }
    h1 { color: #2c3e50; }
    ...
    .edit-form input { padding: 4px; font-size: 13px; width: 100%; box-sizing: border-box; }
    a { color: #4472C4; }
  </style>
</head>
<body>
  ...
  <table>
    <tr>
      <th>生徒ID</th><th>氏名</th><th>担当教科</th><th>操作</th>
    </tr>
    {% for s in students %}
    <tr>
      <form method="POST">
